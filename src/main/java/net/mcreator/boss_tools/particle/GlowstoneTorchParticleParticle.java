...
package net.mcreator.boss_tools.particle;
...
public class GlowstoneTorchParticleParticle extends BossToolsModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public GlowstoneTorchParticleParticle(BossToolsModElements instance) {
		super(instance, 436);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("glowstone_torch_particle"));
	}
