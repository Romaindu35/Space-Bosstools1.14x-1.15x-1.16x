...
public class GeneratorGUIGui extends BossToolsModElements.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 77, 31) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 77, this.guiTop + 51, 0, 0, 15, 14, 15, 14);
			if (BlastFurnaceFireProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world))) {
				...
				this.blit(this.guiLeft + 77, this.guiTop + 51, 0, 0, 14, 14, 14, 14);
			}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Coal Generator", 47, 5, -13421773);
			...
			this.font.drawString("Inventory", 6, 73, -13421773);
		}
