...
public class CompressorGuiGui extends BossToolsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CompressorGuiGui(BossToolsModElements instance) {
		super(instance, 367);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 61, this.guiTop + 39, 0, 0, 20, 14, 20, 14);
			...
			this.blit(this.guiLeft + 86, this.guiTop + 33, 0, 0, 26, 26, 26, 26);
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Compressor", 7, 6, -13421773);
