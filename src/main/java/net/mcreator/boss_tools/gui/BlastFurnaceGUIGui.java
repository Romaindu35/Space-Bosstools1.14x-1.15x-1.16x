...
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrowProcedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow9Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow8Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow7Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow6Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow5Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow4Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow3Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow2Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow19Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow18Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow17Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow16Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow15Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow14Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow13Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow12Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow11Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceGuiArrow10Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFireProcedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire9Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire8Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire7Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire6Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire5Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire4Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire3Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire2Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire14Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire13Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire12Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire11Procedure;
import net.mcreator.boss_tools.procedures.BlastFurnaceFire10Procedure;
...
public class BlastFurnaceGUIGui extends BossToolsModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 72, this.guiTop + 39, 0, 0, 20, 14, 20, 14);
			...
			if (BlastFurnaceFireProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world))) {
				...
				this.blit(this.guiLeft + 53, this.guiTop + 39, 0, 0, 14, 14, 14, 14);
			}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Blast Furnace", 54, 5, -13421773);
			this.font.drawString("Inventory", 7, 76, -13421773);
		}
