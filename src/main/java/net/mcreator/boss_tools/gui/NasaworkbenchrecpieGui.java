...
public class NasaworkbenchrecpieGui extends BossToolsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public NasaworkbenchrecpieGui(BossToolsModElements instance) {
		super(instance, 214);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("nasaworkbenchrecpie"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(14, this.addSlot(new SlotItemHandler(internal, 14, 134, 45) {
				@Override
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 36, this.guiTop + 72, 0, 0, 256, 256, 256, 256);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("boss_tools:textures/nasaworktexture6.png"));
			this.blit(this.guiLeft + 11, this.guiTop + 72, 0, 0, 256, 256, 256, 256);
			...
			this.blit(this.guiLeft + 76, this.guiTop + 72, 0, 0, 256, 256, 256, 256);
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("NASA Workbench", 4, -39, -13421773);
			this.font.drawString("Inventory", 7, 74, -13421773);
			this.font.drawString("14", 142, 40, -1);
		}
