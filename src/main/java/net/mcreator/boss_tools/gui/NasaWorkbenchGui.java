...
public class NasaWorkbenchGui extends BossToolsModElements.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 47, 6) {
			}));
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 30, 23) {
			}));
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 47, 23) {
			}));
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 30, 40) {
			}));
			this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 47, 40) {
			}));
			this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 13, 40) {
			}));
			this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 64, 40) {
			}));
			this.customSlots.put(11, this.addSlot(new SlotItemHandler(internal, 11, 13, 57) {
			}));
			this.customSlots.put(12, this.addSlot(new SlotItemHandler(internal, 12, 64, 57) {
			}));
			this.customSlots.put(13, this.addSlot(new SlotItemHandler(internal, 13, 38, 57) {
			}));
			this.customSlots.put(14, this.addSlot(new SlotItemHandler(internal, 14, 133, 45) {
				@Override
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("NASA Workbench", 4, -38, -13421773);
			this.font.drawString("Inventory", 7, 74, -13421773);
		}
