...
import net.mcreator.boss_tools.procedures.Oxygenlargeshow2Procedure;
import net.mcreator.boss_tools.procedures.Oxygenlargeshow1Procedure;
import net.mcreator.boss_tools.procedures.OxygenaddlargeProcedure;
import net.mcreator.boss_tools.procedures.OxygenRemovelargeProcedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire9Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire8Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire7Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire6Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire5Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire4Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire3Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire2Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire1Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire13Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire12Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire11Procedure;
import net.mcreator.boss_tools.procedures.OxygenGeneratorFire10Procedure;
...
public class OxygenBulletGeneratorGUIGui extends BossToolsModElements.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 75, 44) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 76, this.guiTop + 28, 0, 0, 15, 14, 15, 14);
			...
			this.blit(this.guiLeft + 10, this.guiTop + -10, 0, 0, 21, 11, 21, 11);
		}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Oxygen Generator", 37, 5, -13421773);
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + -20, this.guiTop + 25, 20, 20, "-", e -> {
				BossToolsMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
				handleButtonAction(entity, 0, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + -20, this.guiTop + 5, 20, 20, "+", e -> {
		...
		if (buttonID == 0) {
			{
				...
				OxygenRemovelargeProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				OxygenaddlargeProcedure.executeProcedure($_dependencies);
			}
		}
	}
