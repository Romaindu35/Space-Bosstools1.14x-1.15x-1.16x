...
public class PlayerRotationsTier3Procedure extends BossToolsModElements.ModElement {
	public PlayerRotationsTier3Procedure(BossToolsModElements instance) {
		super(instance, 429);
	...
	public void setupPlayerAngles(PlayerModelEvent.SetupAngles.Post event) {
		...
		if (((player.getRidingEntity()) instanceof RocketTier3Entity.CustomEntity)) {
			{
