...
public class OrbitMoonDimension extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:orbit_moon")
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("orbit_moon"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("boss_tools:orbit_moon")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("boss_tools:orbit_moon"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("boss_tools:orbit_moon"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("boss_tools:orbit_moon_biom")),};
	}
