...
public class OrbitMarsDimension extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:orbit_mars")
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("orbit_mars"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("boss_tools:orbit_mars")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("boss_tools:orbit_mars"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("boss_tools:orbit_mars"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("boss_tools:orbit_mars_biom")),};
	}
