...
public class OrbitMercuryDimension extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:orbit_mercury")
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("orbit_mercury"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("boss_tools:orbit_mercury")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("boss_tools:orbit_mercury"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("boss_tools:orbit_mercury"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("boss_tools:orbit_mercury_biom")),};
	}
