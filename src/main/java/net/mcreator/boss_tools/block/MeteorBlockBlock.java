...
public class MeteorBlockBlock extends BossToolsModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(20f, 10f).lightValue(0).harvestLevel(1)
