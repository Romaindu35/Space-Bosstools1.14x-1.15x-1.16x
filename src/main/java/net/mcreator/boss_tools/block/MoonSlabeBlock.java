...
public class MoonSlabeBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:moon_slabe")
	public static final Block block = null;
	public MoonSlabeBlock(BossToolsModElements instance) {
		super(instance, 23);
	}
