...
public class MrrcuryCobblestoneBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:mrrcury_cobblestone")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mrrcury_cobblestone");
		}
