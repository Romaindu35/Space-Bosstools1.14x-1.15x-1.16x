...
import net.mcreator.boss_tools.procedures.AlienOnEntityTickUpdateProcedure;
...
public class AlienEntity extends BossToolsModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777012, -16724788, new Item.Properties().group(BossToolsItemGroup.tab))
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new VillagerModel(0), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity1) {
				return new ResourceLocation("boss_tools:textures/alien.png");
			}
		});
	}
