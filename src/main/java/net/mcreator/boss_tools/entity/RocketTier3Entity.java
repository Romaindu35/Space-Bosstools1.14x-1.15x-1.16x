...
import net.mcreator.boss_tools.gui.RocketTier3GuiFuelGui;
...
public class RocketTier3Entity extends BossToolsModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 4f)).build("rocket_tier_3")
						.setRegistryName("rocket_tier_3");
