...
import net.mcreator.boss_tools.procedures.Tier1RocketItemRightClickedOnBlockProcedure;
...
public class Tier1RocketItemItem extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:tier_1_rocket_item")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tier_1_rocket_item");
		}
