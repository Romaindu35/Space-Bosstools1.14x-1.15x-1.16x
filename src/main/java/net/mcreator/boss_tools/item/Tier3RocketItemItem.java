...
import net.mcreator.boss_tools.procedures.Tier3RocketItemRightClickedOnBlockProcedure;
...
public class Tier3RocketItemItem extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:tier_3_rocket_item")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tier_3_rocket_item");
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				Tier3RocketItemRightClickedOnBlockProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
