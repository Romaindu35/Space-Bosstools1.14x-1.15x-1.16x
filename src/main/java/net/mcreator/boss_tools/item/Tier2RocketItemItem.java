...
import net.mcreator.boss_tools.procedures.Tier2RocketItemRightClickedOnBlockProcedure;
...
public class Tier2RocketItemItem extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:tier_2_rocket_item")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tier_2_rocket_item");
		}
