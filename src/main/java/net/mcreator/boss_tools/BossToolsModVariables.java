...
public class BossToolsModVariables {
	public BossToolsModVariables(BossToolsModElements elements) {
	...
	public static double Timer4 = 0;
	public static double Timer5 = 0;
	public static double Timer6 = 0;
	public static double Timer7 = 0;
	@CapabilityInject(PlayerVariables.class)
	public static Capability<PlayerVariables> PLAYER_VARIABLES_CAPABILITY = null;
	@SubscribeEvent
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("boss_tools", "player_variables"), new PlayerVariablesProvider());
	}
