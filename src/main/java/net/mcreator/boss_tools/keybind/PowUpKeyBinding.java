...
import net.mcreator.boss_tools.procedures.PowUpOnKeyReleasedProcedure;
...
public class PowUpKeyBinding extends BossToolsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.pow_up", GLFW.GLFW_KEY_SPACE, "key.categories.gameplay");
