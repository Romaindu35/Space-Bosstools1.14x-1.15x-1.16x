...
import net.mcreator.boss_tools.procedures.LandingGearSpaceProcedure;
...
public class LandingearSpaceHotkeyKeyBinding extends BossToolsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.landingear_space_hotkey", GLFW.GLFW_KEY_SPACE, "key.categories.gameplay");
		...
		if (type == 0) {
			{
				...
				LandingGearSpaceProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
