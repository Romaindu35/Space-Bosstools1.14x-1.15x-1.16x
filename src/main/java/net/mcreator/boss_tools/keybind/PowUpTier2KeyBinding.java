...
import net.mcreator.boss_tools.procedures.PowUponkeypressProcedure;
...
public class PowUpTier2KeyBinding extends BossToolsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public PowUpTier2KeyBinding(BossToolsModElements instance) {
		super(instance, 172);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.pow_up_tier_2", GLFW.GLFW_KEY_SPACE, "key.categories.spacebosstools");
		...
		if (type == 0) {
			{
				...
				PowUponkeypressProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
