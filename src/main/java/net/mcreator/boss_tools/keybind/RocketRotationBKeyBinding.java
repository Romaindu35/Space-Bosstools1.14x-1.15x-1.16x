...
import net.mcreator.boss_tools.procedures.RotationBReleasedProcedure;
import net.mcreator.boss_tools.procedures.RotationBProcedure;
...
public class RocketRotationBKeyBinding extends BossToolsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	private long lastpress = 0;
	public RocketRotationBKeyBinding(BossToolsModElements instance) {
		super(instance, 421);
		...
		if (type == 0) {
			{
				...
				RotationBProcedure.executeProcedure($_dependencies);
			}
		}
		if (type == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				RotationBReleasedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
