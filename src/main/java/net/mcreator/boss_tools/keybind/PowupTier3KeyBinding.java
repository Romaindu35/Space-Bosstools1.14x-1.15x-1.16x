...
import net.mcreator.boss_tools.procedures.PowUponkeypressTier3Procedure;
...
public class PowupTier3KeyBinding extends BossToolsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.powup_tier_3", GLFW.GLFW_KEY_SPACE, "key.categories.spacebosstools");
		...
		if (type == 0) {
			{
				...
				PowUponkeypressTier3Procedure.executeProcedure($_dependencies);
			}
		}
	}
}
