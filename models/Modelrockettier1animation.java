...
public static class Modelrockettier1animation extends AnimatedEntityModel {

	private final AnimatedModelRenderer Rocket;

	public Modelrockettier1animation() {
		textureWidth = 512;
		textureHeight = 256;
	...
	public ResourceLocation getAnimationFileLocation() {
		return new ResourceLocation("boss_tools", "animations/RocketTier1Animation.json");
	}
